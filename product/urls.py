...
from .views import (
    get_languages_view,
    GenreListView, GenreChildrenView, GenreParentsView, GenreProductsView,
    SearchProductView, ProductRetrieveView,
...
urlpatterns = [
    ...
    re_path('^genres/(?P<id>.+)/products/$', GenreProductsView.as_view(), name='product_genre_products_list'),
    # Products
    ...
    # path('popular-products/', PopularProductsView.as_view(), name='product_popular_list'),
