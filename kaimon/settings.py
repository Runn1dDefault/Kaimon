...
PAYBOX_TEST_ID = config("PAYBOX_TEST_ID")
PAYBOX_TEST_SECRET_KEY = config("PAYBOX_TEST_SECRET_KEY")
PAYBOX_TEST_SALT = config("PAYBOX_TEST_SALT")
PAYBOX_TEST_RESULT_URL = config("PAYBOX_TEST_RESULT_URL")
PAYBOX_TEST_SUCCESS_URL = config("PAYBOX_TEST_SUCCESS_URL")
PAYBOX_TEST_FAILURE_URL = config("PAYBOX_TEST_FAILURE_URL")
