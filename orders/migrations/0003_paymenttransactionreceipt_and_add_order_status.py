...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='orders.order', related_name='payment_transaction')),
        ...
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.CharField(choices=[('wait_payment', 'Wait Payment'), ('payment_rejected', 'Payment Rejected'), ('pending', 'Pending'), ('in_process', 'In Process'), ('in_delivering', 'In Delivering'), ('success', 'Success')], default='wait_payment', max_length=20),
        ),
    ]
