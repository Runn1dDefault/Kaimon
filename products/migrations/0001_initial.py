...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Category',
            fields=[
                ('id', models.CharField(default=service.utils.uid_generate, max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_unit_price', models.DecimalField(decimal_places=10, default=0, max_digits=20)),
